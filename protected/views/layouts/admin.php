                    	...
                    	<div class="navbar">
                        	<div class="navbar-inner Gradient-Style1">
                            	<ul class="nav">
                                    ...
                                    <?php } ?>
                                    <li class="separator-Vertical"><a class="Font-Color-White" href="#">Layanan Kami</a></li>
                                    <li class="separator-Vertical"><a class="Font-Color-White" href="<?php echo Yii::app()->createUrl('//article') ?>">Artikel</a></li>
                                    <li class="separator-Vertical"><a class="Font-Color-White" href="#">Kontak</a></li>
                                    <li class="separator-Vertical"><a class="Font-Color-White" href="#">Faq</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
