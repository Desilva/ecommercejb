...
?>
    ...
    <a href="javascript:void(0)" data-trigger='hover' title='Alasan Penolakan' data-placement='top' data-content='<?php echo $model->alasan_penolakan ?>' rel='popover'><strong><?php echo $model->status_approval ?></strong></a>
<?php
    }
    else
    {
