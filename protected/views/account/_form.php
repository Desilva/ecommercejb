...
<div class="account-create-row">
	...
	<?php echo $form->radioButtonList($model,'id_category',$kategori,array("class"=>"radio-button-account-create",'onchange'=>'changeCategory(2)','separator'=>'', 'labelOptions'=>array('style'=>'display:inline'))) ?>
</div>
...
<div class="account-create-row">
	<?php echo CHtml::button('Batal', array('submit' => array("account/index/"), 'class'=>'account-create-button')); ?>
  ...
  <?php echo CHtml::ajaxSubmitButton('Simpan Draft',CHtml::normalizeUrl(array('account/create','render'=>true)),
    ...
    <?php echo CHtml::ajaxSubmitButton('Kirim',CHtml::normalizeUrl(array('account/create')),
     array(
         'dataType'=>'json',
         'type'=>'post',
         'success'=>'function(data) {  
