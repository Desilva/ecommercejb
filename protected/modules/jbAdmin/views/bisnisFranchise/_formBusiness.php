...
<div class="admin-row">
	...
	<div class="admin-row-select">
		<?php echo $form->dropDownList($model,'kepemilikan',$kepemilikan,array('prompt'=>'Pilih Jumlah Kepemilikan','class'=>'admin-select')); ?>
	</div>
</div>
<div class="admin-row">
...
<div class="admin-row">
	...
	<?php echo $form->textField($model,'jumlah_karyawan',array('class'=>'admin-input')); ?>
</div>
<div class="admin-row">
	<label class="control-label"><?php echo $form->labelEx($model,'tahun_didirikan'); ?></label>		
	<div class="admin-row-select-2">
		<?php echo $form->dropDownList($model,'tahun_didirikan',$tahun,array('prompt'=>'Pilih Tahun','class'=>'admin-select')); ?>
	</div>
</div>
<div class="admin-divide-line">
	&nbsp;
...
<div class="admin-row">
  ...
  <?php echo Chtml::textField('penjualan_field','',array('onkeyup'=>'valueCalcWrapper("penjualan_field","Business_penjualan")','class'=>'admin-input')); ?>
</div>
<div class="admin-row">
	<label class="control-label"><?php echo $form->labelEx($model,'hpp'); ?></label>
	<?php echo $form->hiddenField($model,'hpp'); ?>
  <?php echo Chtml::textField('hpp_field','',array('onkeyup'=>'valueCalcWrapper("hpp_field","Business_hpp")','class'=>'admin-input')); ?>
</div>
<div class="admin-row">
  ...
  <?php echo Chtml::textField('laba_bersih_tahun_field','',array('onkeyup'=>'valueCalcWrapper("laba_bersih_tahun_field","Business_laba_bersih_tahun")','class'=>'admin-input')); ?>
</div>
<div class="admin-row">
	<label class="control-label"><?php echo $form->labelEx($model,'total_aset'); ?></label>
	<?php echo $form->hiddenField($model,'total_aset'); ?>
  <?php echo Chtml::textField('total_aset_field','',array('onkeyup'=>'valueCalcWrapper("total_aset_field","Business_total_aset")','class'=>'admin-input')); ?>
</div>
<div class="admin-row">
	<label class="control-label"><?php echo $form->labelEx($model,'marjin_laba_bersih'); ?></label>
	<?php echo $form->textField($model,'marjin_laba_bersih',array('readonly'=>'readonly','class'=>'admin-input')); ?>
</div>
<div class="admin-row">
	<label class="control-label"><?php echo $form->labelEx($model,'laba_bersih_aset'); ?></label>
	<?php echo $form->textField($model,'laba_bersih_aset',array('readonly'=>'readonly','class'=>'admin-input')); ?>
</div>
<div class="admin-row">
	<label class="control-label"><?php echo $form->labelEx($model,'harga_penawaran_penjualan'); ?></label>
	<?php echo $form->textField($model,'harga_penawaran_penjualan',array('readonly'=>'readonly','class'=>'admin-input')); ?>
</div>
<div class="admin-row">
	<label class="control-label"><?php echo $form->labelEx($model,'harga_penawaran_laba_bersih'); ?></label>
	<?php echo $form->textField($model,'harga_penawaran_laba_bersih',array('readonly'=>'readonly','class'=>'admin-input')); ?>
</div>
<div class="admin-row">
	<label class="control-label"><?php echo $form->labelEx($model,'harga_penawaran_aset'); ?></label>
	<?php echo $form->textField($model,'harga_penawaran_aset',array('readonly'=>'readonly','class'=>'admin-input')); ?>
</div>
<div class="admin-divide-line">
	&nbsp;
</div>
...
<div class="admin-row">
	<div class="admin-row-select">
		<?php echo $form->dropDownList($model,'id_alasan_jual_bisnis',Chtml::listData($alasan_jual_bisnis,'id','alasan'),array('prompt'=>'Pilih Alasan','class'=>'alasanJualDropDown admin-select')); ?>             
	</div>
	<label for="alasan_jual_lainnya_check" class="admin-lainnya">
...
<div class="admin-row">
	<?php echo $form->textArea($model,'alasan_jual_bisnis_lainnya',array('class'=>'alasanJualTextArea admin-textarea admin-textarea-lainnya','disabled'=>'disabled')); ?>
</div>
<div class="admin-divide-line">
	&nbsp;
</div>
...
<div class="admin-row">
	<?php
		echo CHtml::button('Batal', array('submit' => array("bisnisFranchise/index/"), 'class'=>'admin-button'));
