...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2013 at 12:55 PM
...
CREATE TABLE IF NOT EXISTS `business` (
  ...
  `laba_bersih_tahun` int(11) DEFAULT NULL,
  `total_aset` int(11) DEFAULT NULL,
  `marjin_laba_bersih` int(11) DEFAULT NULL,
  `laba_bersih_aset` int(11) DEFAULT NULL,
  `harga_penawaran_penjualan` int(11) DEFAULT NULL,
  `harga_penawaran_laba_bersih` int(11) DEFAULT NULL,
  `harga_penawaran_aset` int(11) DEFAULT NULL,
  `harga_min` int(11) NOT NULL,
  `harga_max` int(11) NOT NULL,
  `alasan_jual_bisnis` varchar(500) DEFAULT NULL,
  `franchise_alasan_kerjasama` varchar(500) DEFAULT NULL,
  `franchise_persyaratan` varchar(500) DEFAULT NULL,
  `franchise_menu` varchar(500) DEFAULT NULL,
  `franchise_dukungan_franchisor` varchar(500) DEFAULT NULL,
...
INSERT INTO `m_industri` (`id`, `industri`) VALUES
(1, 'Industri 1'),
(2, 'Industri 2');
...
INSERT INTO `m_sub_industri` (`id`, `id_industri`, `sub_industri`) VALUES
(1, 1, 'Sub Industri 1'),
(2, 1, 'Sub Industri 2'),
(3, 1, 'Sub-industri 3'),
(4, 2, 'Sub-industri 4'),
...
INSERT INTO `user` (`id`, `id_nationality`, `id_job`, `password`, `email`, `first_name`, `last_name`, `gender`, `address`, `phone`, `handphone`, `birth_place`, `date_of_birth`, `instansi`, `income`, `office_address`, `office_phone`, `religion`, `marital_status`, `id_buyer_category`, `id_buyer_location`, `id_buyer_price`, `references`, `newsletter_status`) VALUES
(3, 1, 1, 'ee11cbb19052e40b07aac0ca060c23ee', 'user@jb.com', 'user', 'user', '', '', '', '', NULL, NULL, '', '', '', '', '', '', NULL, NULL, NULL, NULL, NULL),
(4, 1, 1, '21232f297a57a5a743894a0e4a801fc3', 'admin@jb.com', 'admin', 'admin', NULL, '', '', '', NULL, NULL, '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 1, 1, 'ee11cbb19052e40b07aac0ca060c23ee', 'user2@jb.com', 'user', 'user', NULL, '', '', '', NULL, NULL, '', '', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 1, 2, '7e58d63b60197ceb55a1c487989a3720', 'user3@jb.com', 'user', 'user', 'L', 'user', 'user', 'user', '', '2013-07-30 00:00:00', 'user', '<2jt', 'user', '', NULL, NULL, 2, 1, 1, NULL, NULL),
(7, 1, 1, '81dc9bdb52d04dc20036dbd8313ed055', 'userzz@jb.com', '1234', '1234', 'L', '1234', '1234', '1234', 'City 1', '2013-07-09 00:00:00', '1234', '<2jt', '1234', '1234', NULL, NULL, 2, 1, 2, NULL, NULL),
(8, 1, 1, '81dc9bdb52d04dc20036dbd8313ed055', 'admin2@jb.com', '1234', '1234', 'L', '1234', '1234', '1234', 'City 1', '2013-07-03 00:00:00', '1234', '<5jt', '1234', '1234', 'Kristen', 'Belum Menikah', 1, 1, 1, NULL, 1);
