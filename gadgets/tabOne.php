<div id="tabsholder">
    <ul class="tabs">
        <li id="tab1">Rekomendasi Kami</li>
        <li id="tab2">Terbaru</li>
    </ul>
      					...
      					<div class="ad-nav">
        						<div class="ad-thumbs">
          							<ul class="ad-thumb-list">
            							<li>
              								<a data-placement="bottom" data-trigger="hover" href="#" id="tes" class="btn btn-large btn-danger" data-toggle="popover" title="" data-content="And here's some amazing content. It's very engaging. right?" data-original-title="A Title">
